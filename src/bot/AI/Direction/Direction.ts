class Direction {
  ...
  public static DIRECTION_TOP_RIGHT = 7 / 4 * Math.PI;
  public static DIRECTION_TOP = 3 / 2 * Math.PI;
  public static DIRECTION_TOP_LEFT = 5 / 4 * Math.PI;
  public static DIRECTION_LEFT = Math.PI;
  public static DIRECTION_DOWN_LEFT = 3 / 4 * Math.PI;
  public static DIRECTION_DOWN = Math.PI / 2;
  public static DIRECTION_DOWN_RIGHT = Math.PI / 4;
